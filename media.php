            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="hidden-xs hidden-sm list-group" style="margin-top: 20%">
                        ...
                        <a href="media.php" class="runika-active list-group-item text-center runika-nav-li">MEDIA</a>
            ...
            <nav id="nav" class="visible-xs-block visible-sm-block navbar navbar-inverse">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="hidden-sm navbar-brand" href="#">MEDIA</a>
                    </div>
