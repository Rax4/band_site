        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="hidden-sm hidden-xs list-group" style="margin-top: 20%">
                        ...
                        <a href="download.php" class="runika-active list-group-item text-center runika-nav-li">DO POBRANIA</a>
                    </div>
                </div>
                <div class="col-md-2"></div>
            </div>
            ...
            <nav id="nav" class="visible-xs-block visible-sm-block navbar navbar-inverse">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="hidden-sm navbar-brand" href="#">ZAWARTOŚĆ DO POBRANIA</a>
                    </div>
                <div class="collapse navbar-collapse" id="myNavbar">
                  <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="download.php">DO POBRANIA</a></li>
            ...
            <div class="row">
                ...
                <div class="runika-content col-md-8">
                    ...
                    <!--CONTENT-->
                    <div class="col-md-8">
                        <div id="runika-post runika-downloads-group" class="panel-group">
                            <ul class="runika-files-list">
